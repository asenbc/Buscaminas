...
public class Cell : MonoBehaviour
{
    ...
    //Creamos unas variables donde guardar la posción de la celda concreta
    int x, y;
    ...
    void Start()
    {
        ...
        y = (int)this.transform.parent.position.y; //La posición en Y del parent de esa celda (la fila)
    ...
    private void OnMouseUpAsButton()
    {
        ...
        else
        {
            ...
            //Descubrir toda el área sni minas alrededor de la celda destapada
